...
Recently I decided to host my personal portfolio site using [GitHub pages](https://pages.github.com/). Even though they have very detailed [instruction](https://help.github.com/articles/using-a-custom-domain-with-github-pages/) on how to setup a custom domain, I found it cumbersome to get to the right information. 🙄

Here are **2** key steps to setup your GitHub pages [enabled](https://guides.github.com/features/pages/) project to use your **custom domain**.
