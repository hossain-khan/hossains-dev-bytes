...
Lately I have been playing a lot with Cloudflare and its services which has generous free tier and I have been loving it. Based on quick research [Astro](https://astro.build/) seemed like a good fit given they were recently acquired by Cloudflare.

## Astro and Cloudflare Workers

The setup wasn't smooth sailing because of the custom theme I chose called [Devosfera](https://astro.build/themes/details/devosfera/). It did not come with a Cloudflare Workers adapter and I had to do some custom configuration to make it work.
