...
There are many more libraries that do the job, however for the rest of the example I will be using PrismJS because of its highly modular nature. Note that, the process of using different library will be _almost_ the same.
...
This setup is going to be specific to the library of your choice. Since we are focusing on PrismJS, we will follow its [official guideline](https://prismjs.com/#basic-usage).
