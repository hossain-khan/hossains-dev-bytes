...
```
val status: **String** = statusResult.*getOrDefault*("STATUS\_UNKNOWN")
```
```
...
**.*onSuccess* **{}  
**.*onFailure* **{}  
**.*recover* **{** error: Throwable **\->** "STATUS\_UNKNOWN" **}  
...
**.*fold*(  
    ...
    onFailure = **{** error: Throwable **\->** "STATUS\_UNKNOWN" **}  
**)
```
