...
Recently, I used Zensical for my new Compose Highlight library and noticed Kotlin syntax highlighting was not fully accurate. 
...
The Zensical site already had build-time highlighting with Pygments which for most Kotlin code blocks was good enough, 
...
Overall, I am very happy with the outcome even if there is split second of "flash" when the page loads and Shiki re-highlights.
