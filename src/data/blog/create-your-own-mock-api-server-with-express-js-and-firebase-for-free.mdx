...
Google has [many many examples](https://github.com/firebase/functions-samples) for cloud functions which showcase 100s of use cases, however, I just wanted to focus on using Express to mock API responses.
...
- Troubleshooting - some known issues and their solutions
