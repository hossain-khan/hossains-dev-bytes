...
While in [part 1](/posts/syntax-highlighting-on-android-bringing-shiki-engine-to-compose/), both cloud based on on-device highlihgting worked, I was wondering how modern apps like ChatGPT, Claude, and Perplexity handle source code highlighting on Android. The code blocks look great - proper colors, correct token boundaries, clean rendering. I was curious what was actually powering that, so I did some further inverstigation on their apps using good old [`apktool`](https://apktool.org/).
...
<div style="display: flex; gap: 1rem; justify-content: center; align-items: flex-start;">
  <figure style="flex: 1; margin: 0; text-align: center;">
    ![Sample app home screen showing syntax highlighted code](../../assets/images/android-compose-highlight-home.png)
    <figcaption>Sample app with different languages</figcaption>
  </figure>
  <figure style="flex: 1; margin: 0; text-align: center;">
    ![Benchmark performance results for syntax highlighting](../../assets/images/android-compose-highlight-perf.png)
