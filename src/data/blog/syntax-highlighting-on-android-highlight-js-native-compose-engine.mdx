...
While I was [investigating](/posts/syntax-highlighting-on-android-bringing-shiki-engine-to-compose/) syntax highlighting on Android, I was wondering how modern apps like ChatGPT, Claude, and Perplexity handle source code highlighting on Android. The code blocks look great - proper colors, correct token boundaries, clean rendering. I was curious what was actually powering that, so I did some further inverstigation on their apps.
...
That pattern was elegant enough that I decided to experiment with it and build a proof-of-concept library for Jetpack Compose.
