...
Here is a [benchmark](https://github.com/hossain-khan/json5-kotlin/tree/main/benchmark) of generated library vs two relevant contenders 💪
...
Yes, some of the parsing tests were failing and the agent was repeatedly failing to fix it. I almost lost hope. Then GitHub Copilot Agent rescued me.
...
I had an absolute blast just watching agents do magical stuff that I couldn’t have done by myself. Even the benchmarking solution was built by an Agent.   
