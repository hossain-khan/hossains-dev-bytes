...
With new version of `compose-highlight` published, I [swapped](https://github.com/hossain-khan/android-code-with-ai/pull/223) out the old composable with new streaming supported highlighting:
...
Dogfooding my own library in real applications is humbling. On paper, `SyntaxHighlightedCode` did work for static code snippets. But the moment I plugged it into a streaming AI scenario, it presented new challenges! 🤓
