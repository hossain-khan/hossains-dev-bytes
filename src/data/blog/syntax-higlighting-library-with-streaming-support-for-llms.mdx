...
With `compose-highlight` 0.35.0 published, I returned to the AI Chat app and [swapped](https://github.com/hossain-khan/android-code-with-ai/pull/223) out the composable:
